...
% Add nodal Neumann loads (point loads) at given node IDs (1D).
%
% Inputs
...
%
% Notes
%   - In 1D, a Neumann boundary condition contributes a boundary term at an endpoint.
%   - Nodal values are applied directly.
